...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    if ($accion === 'reiniciar_todo') {
        reiniciar_ejercicios($pdo, $usuario_id, $tipo, 8, false);
    } elseif ($accion === 'reintentar') {
        reiniciar_ejercicios($pdo, $usuario_id, $tipo, 8, true);
    }
}

$ejercicios = asegurar_ejercicios($pdo, $usuario_id, $tipo, 8, 1);
...
<body>
    ...
    <div class="nav-series">
        <a class="btn-nav activo" href="index.php">&larr; Retos 1-8</a>
        <a class="btn-nav" href="sumas_2dig.php">Retos 9-16 &rarr;</a>
    </div>
    ...
    <script>
        ...
        function irAEjercicio(numero, yaResuelto) {
            ...
            window.location.href = "ejercicio.php?ejercicio=" + numero + "&tipo=6d";
        }
